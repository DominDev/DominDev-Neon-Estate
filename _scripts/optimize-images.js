 ...
 *    npm install sharp --save-dev
 *
 * 2. Umieść oryginalne obrazy w folderze:
 *    - assets/images/originals/
 *
 * 3. Uruchom skrypt:
 *    node _scripts/optimize-images.js
 *
 * 4. Zoptymalizowane obrazy zostaną wygenerowane w:
 *    - assets/images/ (400w, 800w, 1200w, 1600w w formatach AVIF, WebP, JPG)
 *
 * ═══════════════════════════════════════════════════════════════════
 * CO ROBI SKRYPT:
 * ═══════════════════════════════════════════════════════════════════
 ...
 * │   └── og-image.png
 * ├── hero-villa-400.avif      ← Wygenerowane przez skrypt
 * ├── hero-villa-400.webp
 * ├── hero-villa-400.jpg
 * ├── hero-villa-800.avif
 * ├── ... (wszystkie warianty: 400w, 800w, 1200w, 1600w × 3 formaty)
 * └── ...
 *
 * ═══════════════════════════════════════════════════════════════════
 */
